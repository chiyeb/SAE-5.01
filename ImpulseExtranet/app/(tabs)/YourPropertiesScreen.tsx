  ...
  useEffect(() => {
    if (token) {
      const fetchBiens = async () => {
        ...
        try {
          const data = await getAllPropertiesForCurrentUser(selectedTab,token);
      ...
      <Animated.View style={[styles.background, { backgroundColor: getBackgroundColor }]}>
        ...
        >
          <View style={styles.titleContainer}>
            <ThemedText type="title">Vos biens</ThemedText>
          </View>
