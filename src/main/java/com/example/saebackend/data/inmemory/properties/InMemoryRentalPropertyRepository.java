...
/**
 * In-memory implementation of the RentalPropertyRepository interface.
 * Provides methods for managing rental properties stored in memory.
 */
@Repository
public class InMemoryRentalPropertyRepository implements RentalPropertyRepository {
    ...
    public InMemoryRentalPropertyRepository(UserRepository userRepository) {
