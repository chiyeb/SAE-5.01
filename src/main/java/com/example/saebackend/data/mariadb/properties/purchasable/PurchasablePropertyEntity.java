...
public class PurchasablePropertyEntity extends PropertyEntity {
    ...
    public PurchasablePropertyEntity(String id, String type, String title, String description, LocationEntity location, List<String> images, double livingArea, double landArea, Map<RoomTypeEntity, Integer> rooms, String orientation, String energyClass, String climateClass, String view, double estimationEnergyCost, double price) {
