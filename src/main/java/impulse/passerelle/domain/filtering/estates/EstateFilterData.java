...
public record EstateFilterData(String pays, String code_postal, Integer type_bien, Double max_budget, Double surface,
                               ...
                               String class_energie, String class_climat, Integer nb_salle_bain, Boolean piscine, String orientation, String type_offre, Boolean meuble, Boolean professionnel) {
