...
public class JsonObjetsSerializer implements JsonSerializer<Objets> {
    /**
     ...
     */
    @Override
    public JsonElement serialize(Objets src, Type typeOfSrc, JsonSerializationContext context) {
