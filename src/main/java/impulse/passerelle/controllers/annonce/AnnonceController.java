...
public class AnnonceController {
    ...
    public ResponseEntity<String> getAllAnnonces(
        ...
        SortData sortData = (tri_valeur != null) ?
                ...
                null;
        EstateFilterData filterData = new EstateFilterData(pays, ville, type_bien, max_budget, surface, nombre_pieces, nombres_chambres, habitable_surface_min, habitable_surface_max, class_energie, class_climat, nb_salle_bain, piscine, orientation, type_offre);
